...
<div class="page-header">
	<h1><spring:message code="title.a3es.accreditation.processes"/> <small><c:out value="${form.accreditationProcess.processName}"/></small></h1>
</div>
...
<form:form role="form" modelAttribute="form" method="POST" class="form-horizontal" action="${editUrl}">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input id="executionYear" name="executionYear" class="form-control" value="<c:out value='${form.executionYear.qualifiedName}'/>" readonly="readonly"/>
		</div>
	</div>
	<div class="form-group">
